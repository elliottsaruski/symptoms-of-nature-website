...
import anikaImg from "../assets/media/photos/ROSTER/anikahudaPFP.jpg";
...
export const roster = [
  {
    ...
    links: [{ instagram: "https://www.instagram.com/xcopemusic/" }],
    profileType: "music",
  ...
  },
  {
    ...
    links: [{ instagram: "https://www.instagram.com/chr0mec0/" }],
    profileType: "fashion",
    featured_in: ["ZINE #000"],
  },
  {
  ...
  },
  {
    ...
    title: "designer",
    description: "",
    links: [{ instagram: "https://www.instagram.com/eatbonez/" }],
  ...
  },
  {
    ...
    links: [{ instagram: "https://www.instagram.com/outoforder_music/" }],
    profileType: "music",
    featured_in: ["ZINE #000"],
  },
  {
  ...
  },
  {
    ...
    links: [{ instagram: "https://www.instagram.com/t.sanch_/" }],
    profileType: "music",
    featured_in: ["ZINE #000"],
  },
  {
    ...
    links: [{ instagram: "https://www.instagram.com/elliottsaruski/" }],
    profileType: "music",
    featured_in: ["ZINE #000"],
  },
  {
    ...
    title: "producer",
    description:
      "“Not afraid of nostalgia and where abstract electronic music once took us, Sohn Jamal reshapes the familiar within unfamiliar channels and is very much present in the now.” - Pietro Da Sacco, Igloomag \n\nSohn Jamal (real name John Small) stands out as an artist that consistently pushes the limits of electronic music. Renowned for his avant-garde aesthetic, he expertly combines components from numerous subgenres to produce a sound that is all his own. He creates a tapestry of captivating auditory environments by drawing inspiration from beat music, footwork, ambient, jazz and IDM. \n\nHaving originally grown up in Tokyo, Japan, Small relocated to Miami in 2014 to study jazz guitar. His first album, “Suzy”, came out in 2018 on vinyl under Night Young. After releasing a series of singles and eps digitally through various Miami labels and his own imprint TY Tapes, he released his second album “Scroo Amethyst” in 2022 under Schematic Music Company. A promo single “UR21201820” was released in anticipation of the project. \n\nIn 2023, Small released two collaborative EPs. The first, “Simhuman Fortitude”, was with Tokyo-based IDM/glitch pop artist Serph, which charted at number 4 on the iTunes electronic music charts in Japan. The second, “Don't Let the Body Up”, was with Low End Resorts, a newer alias of Romulo Del Castillo (Soul Oddity, Phoenecia) and Nick Forte through Schematic. \n\nAs a producer, DJ and multi-instrumentalist, he has supported for artists such as Machinedrum, Flying Lotus, Vegyn, Iglooghost, Shinichiro Yokota, Deantoni Parks, Eevee, Khruangbin, and Plaid.",
    links: [{ instagram: "https://www.instagram.com/sohn.jamal/" }],
    profileType: "music",
    featured_in: ["ZINE #000"],
  },
  {
    ...
    links: [{ instagram: "https://www.instagram.com/charlesnimbus/" }],
    profileType: "music",
    featured_in: ["ZINE #000"],
  },
  {
    ...
    links: [{ instagram: "https://www.instagram.com/cybashawty/" }],
    profileType: "music",
    featured_in: ["ZINE #000"],
  },
  {
  ...
  },
  {
    ...
    description:
      "Neeks is a Bengali-American graphic designer based in South Florida.",
    links: [{ instagram: "https://www.instagram.com/nikachu13/" }],
    profileType: "graphic designer",
    featured_in: ["ZINE #000"],
  },
];
